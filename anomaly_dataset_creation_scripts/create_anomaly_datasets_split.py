...
for size in sizes:
  ...
  df_anomalies.to_csv(
      f"anomaly_split_files/anomaly_spectra_s{size}.csv",
      index=False
  )
  ...
  for split_size in split_sizes:
    ...
    df_train.to_csv(f"anomaly_split_files/train_datak{split_size}.csv", index=False)

    excluded_protein = pd.read_csv(f"anomaly_split_files/anomaly_spectra_s{size}.csv")
    ...
    df_test.to_csv(f"anomaly_split_files/test_data-mixedk{split_size}.csv", index=False)
