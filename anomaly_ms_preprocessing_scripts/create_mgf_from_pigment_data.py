...
"""
create_mgf_from_pigment_data.py
===================
This script preprocesses the pigments SIMS-TOFS dataset to create "mgf" like files.
The pigments files are in txt files withe each containing one single broad spectrum with two columns representing
...
ASC_DIR = "/hdd/data/fahmed/pigments_dataset"  # run from the folder
...
#Each pigment has a positve and negative file
polarity_map = {
    "01": "positive",
    "02": "negative",
}
