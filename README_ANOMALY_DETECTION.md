...
1. Run ./anomaly_dataset_creation_scripts/run cluster_anomalies.sh 
...
2. ./anomaly_expirement_scripts/sweep_bucket_size.sh this script sweeps differnt mz intervals can be used later to generate a tradeoff graph
