...
#define SWIG_name    "_louvain_module"
/* -----------------------------------------------------------------------------
...
/*-----------------------------------------------
              @(target):= _louvain_module.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__louvain_module

#else
#  define SWIG_init    init_louvain_module
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_run_louvain__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "run_louvain" "', argument " "1"" of type '" "std::string const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "run_louvain" "', argument " "1"" of type '" "std::string const &""'"); 
  }
  arg1 = reinterpret_cast< std::string * >(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "run_louvain" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  run_louvain((std::string const &)*arg1,arg2);
...
SWIGINTERN PyObject *_wrap_run_louvain__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg1 = reinterpret_cast< std::string * >(argp1);
  run_louvain((std::string const &)*arg1);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_run_louvain(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "run_louvain", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    int _v = 0;
    ...
    if (_v) {
      return _wrap_run_louvain__SWIG_1(self, argc, argv);
    }
  }
  if (argc == 2) {
    int _v = 0;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_run_louvain__SWIG_0(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'run_louvain'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    run_louvain(std::string const &,int)\n"
    "    run_louvain(std::string const &)\n");
  return 0;
}


static PyMethodDef SwigMethods[] = {
	 { "run_louvain", _wrap_run_louvain, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
